...
import RicaRica from "src/assets/rica-rica.svg";
import Jamur from "src/assets/jamur.svg";
...
const Menu = () => {
  ...
  return (
    <Layout>
      <div className="py-32 px-10 overflow-hidden">
        <div className="flex w-full gap-28">
          <div className="flex justify-end relative pt-10 min-w-[45%] max-w-[45%] z-20">
            ...
            transition={{delay:4.5,duration:2}}
              src={CircleText}
              loading="lazy"
              className="animate-[spin_20s_linear_infinite] absolute"
            />
            <m.div 
            initial={{opacity:0}}
            animate={{opacity:1}}
            ...
            className="h-full w-full ">
              ...
              >
                <SwiperSlide>
                  <SlideComponent src={MieKalong} name="kalong" btnRef={ref} onChange={setSelected} />
                </SwiperSlide>
                <SwiperSlide>
                  <SlideComponent src={MiePutih} name="putih" btnRef={ref} onChange={setSelected} />
                </SwiperSlide>
              </Swiper>
            </m.div>
          </div>
          <div className="flex-1 relative z-0">
            ...
            <div className="z-20 flex flex-col justify-between w-full h-full">
              ...
              animate={{opacity:1}}
              transition={{delay:2,duration:0.3}}
              className="font-title text-7xl text-primary font-bold mt-20">
                Menu Andalan <br /> Bakmi Ayam 58
              </m.p>
              <div ref={scope} className="z-20 flex flex-col gap-10 pt-24">
                <p className="font-semibold font-title text-5xl text-secondary">
                ...
                {selected === "kalong" ? 'Mie Hitam (asin atau manis), sayur, kuah.' : 'Mie Kuning (asin atau manis), sayur, kuah.'}
                </p>
                <div className="flex">
                  <div className="flex flex-col flex-1 gap-10">
                    <p className="font-title text-secondary text-5xl font-semibold">
                      Topping :
                    </p>
                    <div className="flex gap-10 text-secondary">
                      <div className="flex flex-col items-center gap-5">
                        <img src={Jamur} loading="lazy" />
                        <p>Ayam Jamur</p>
                      </div>
                      <div className="flex flex-col items-center gap-5">
                        <img src={RicaRica} loading="lazy" />
                        <p>Ayam Rica Rica</p>
                      </div>
                    </div>
                  </div>
